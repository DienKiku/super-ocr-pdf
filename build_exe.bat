...
powershell -Command "Compress-Archive -Path 'dist\SuperOCRPDFStudio\*' -DestinationPath 'dist\SuperOCRPDFStudio_v3.4.0_Portable_Win64.zip' -Force" 2>nul
if exist "dist\SuperOCRPDFStudio_v3.4.0_Portable_Win64.zip" (
    echo Da tao goi nen thanh cong: dist\SuperOCRPDFStudio_v3.4.0_Portable_Win64.zip
